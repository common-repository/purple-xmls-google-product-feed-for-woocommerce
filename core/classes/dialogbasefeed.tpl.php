					...
					<div class="inside export-target">
						...
						<div class="create-feed-container">
							...
							<div class="feed-right">
								...
								<div class="feed-right-row">
									<?php echo wp_kses($this->categoryList( $this->initial_remote_category ), excpf_kses_criteria()); ?>
								</div>
						...
						<a href="#cpf_advance_command_desc"><input class="button-primary"
										...
										<div class="feed-advanced" id="feed-advanced-default">
											<textarea  class="feed-advanced-text"
																id="feed-advanced-text-default"><?php echo esc_html( $this->advancedSettings ); ?></textarea>
			...
			<?php } else { ?>
				...
				<div class="postbox">
					...
					<div class="service_name_long hndle">
						...
						<h3 class="hndle"><?php echo esc_html( $this->service_name_long ); ?></h3>
						...
						<div class="">
							...
							<div class='amazon-template-table'>
								<?php echo esc_html( $this->plugin_message . ' ' ); ?>
								<a class="button-primary" target="_blank"
								   href="<?php echo esc_html( $this->plugin_link ); ?>">Get <?php echo esc_html( $this->service_name ); ?>
									Plugin Here
								</a>
...
<?php if ( isset( $_REQUEST['feed_type'] ) && sanitize_text_field( wp_unslash( $_REQUEST['feed_type'] ) ) == 1 && isset( $_REQUEST['id'] ) && sanitize_text_field( wp_unslash( $_REQUEST['id'] ) ) != '' ) { ?>
